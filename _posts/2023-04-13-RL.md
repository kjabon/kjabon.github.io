...
\hline  
  &o & & & x & & &r_1 = 1, s_1=1, a_1=1\\ 
\hline  
  & &o & & x & & &r_2 = 2, s_2=2, a_2=1\\ 
\hline  
  & & &o& x & & &r_3 = 3, s_3=3, a_3=1\\ 
\hline  
 & & & & o & & &r_4 = 4, s_4=4\\ 
\hline  
\end{array} 
...
A trajectory is any contiguous subsequence of an episode, while an episode is the full sequence from initial state $$s_0$$ to terminal state $$s_T-1$$ for an episode of length $$T$$, if it ends at all.
 {% enddetails %}
