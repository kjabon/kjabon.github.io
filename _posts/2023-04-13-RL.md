...
---
If you're interested in RL, this is the place to start. It's successfully defeated grandmasters in Go, Dota 2, and is responsible for training ChatGPT. 

{% include figure.html path="assets/img/humanfeedbackjump.gif" title="Noodle" class="img-fluid rounded" %} 
<div class="caption">
As noted by [Amid Fish](http://amid.fish/reproducing-deep-rl), it can even teach a noodle to do a backflip.
