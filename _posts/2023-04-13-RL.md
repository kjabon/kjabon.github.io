...
#####See this post on the reinforcement learning problem.

In the standard setup of the reinforcement learning problem, you have an actor and an environment interacting in a loop. (Pic)
