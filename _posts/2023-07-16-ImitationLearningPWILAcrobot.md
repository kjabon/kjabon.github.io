...
<div class="caption">
Currently access to this kind of hardware shouldn't be assumed, however, including [force sensors](https://www.nature.com/articles/s41467-021-27261-0) in our observation will hopefully become the norm. 
</div>
...
First, we collect trajectories from an ILQR controller for swingup. The environment terminates and resets once the top is reached within some tolerance. Taking inspiration from [DART](https://arxiv.org/abs/1703.09327), since we have the option, we inject the ILQR controller's actions with noise.
