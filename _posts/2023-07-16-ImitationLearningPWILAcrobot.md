...
{% include figure.html path="assets/img/acrobot_pwil_1M.jpg" title="pwil" class="img-fluid rounded" caption="Acrobot run for 1M timesteps with PWIL." %} 
