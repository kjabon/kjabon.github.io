...
The main question of this post is: what can we do with imitation learning that we *can't* do with plain RL? Well, there some situations in which it can help us out. 
...
- The reward function is adequate to learn accomplishing the goal, but it accomplishes it in an undesirable way.
