...
***
<center><figure class="flex flex-col"><a href="https://youtu.be/kVmp0uGtShk" target="_blank" rel="noopener noreferrer" class="relative block"><div class="relative w-full h-full absolute top-0 left-0" style="aspect-ratio:16/9;"><iframe frameborder="0" allow="autoplay; fullscreen" allowfullscreen="" style="cursor:pointer;" class="w-full h-full absolute top-0 left-0" src="https://player.vimeo.com/video/365132002?h=689a8eff63&amp;autopause=0&amp;autoplay=0&amp;background=1&amp;loop=1&amp;muted=1&amp;playsinline=1&amp;transparent=1" data-ready="true"></iframe></div></a><figcaption class="f-caption-1 mt-8">Unperturbed (for reference)</figcaption></figure></center>

***

<center><iframe width="560" height="315" src="https://www.youtube.com/embed/kVmp0uGtShk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></center>
<div class="caption">
In this video, we see RL-trained agents successfully navigating environments, with somewhat goofy behavior. More reference links in that video's description.
</div>
