...
<div class="col-8">
{% include figure.html path="assets/img/d4pg_swingup_fix.gif" title="D4PGfix" class="img-fluid rounded" caption="Acrobot run after 10M training steps with D4PG (10+ rewards removed)." %} 
</div>
 <div class="col">
</div>
</div>
