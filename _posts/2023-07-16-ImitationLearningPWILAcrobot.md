...
{% include figure.html path="assets/plotly/D4PG_train_curve_reward_fix.html" title="D4PG" class="img-fluid rounded" caption="Acrobot run after 10M training steps with D4PG (removed 10+ reward; only negative rewards)." %} 
