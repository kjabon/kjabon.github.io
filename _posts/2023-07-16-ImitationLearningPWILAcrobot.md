...
We're going to focus on the last situation for most of this post. The learned policies may be idiosyncratic. Perhaps they are too jerky, or do things that look obviously goofy or energy-inefficient. For instance, take a look at the RL-trained humanoid running in the video below.

<center>
<iframe width="560" height="315" src="https://www.youtube.com/embed/hx_bgoTF7bs?start=88&autoplay=1&playlist=hx_bgoTF7bs&loop=1" frameborder="0" allowfullscreen></iframe>​
</center>
<div class="caption">
...
However, this sort of manual feature engineering tends to be object class-specific. The features for grasping a glass of water will look very different from those for grasping a raspberry, a sheet of paper, a block of agar, or a chicken egg. This could also end up needing quite a few more sensors than we have available, rather than the usual image and/or robot state observation. 

<img src="https://media.springernature.com/full/springer-static/image/art%3A10.1038%2Fs41467-021-27261-0/MediaObjects/41467_2021_27261_Fig1_HTML.png?as=webp" alt="hand with force sensors" />
<div class="caption">
Including said force sensors (such as those in the fingertips from this 2021 paper) in our observation will hopefully become the norm. Currently access to this kind of hardware shouldn't be assumed.
</div>
