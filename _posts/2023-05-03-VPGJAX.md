...
### Initialize networks
Warning: this section makes up the first half of this post. If you don't feel you need to learn how to implement neural networks for RL in JAX, feel free to skip this section directly to the rest of the reinforcement learning loop.
