...
That's generalized advantage estimation (GAE) in a nutshell.  For more specifics in how these calculations are done, see the [paper](https://arxiv.org/abs/1707.06347).
