...
We have a more accurate approximation with our n-step return $$G$$. We've left out one important piece, though: this isn't actually "advantage" yet. Before we add it, let's talk about why we need it.
...
In any trajectory, there are several sources of randomness contributing to what direction it takes as it's rolled out, ultimately leading to variance of the future return $$R^f$$: 
