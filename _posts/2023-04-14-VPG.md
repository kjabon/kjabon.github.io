...
{% include figure.html path="assets/img/FigAdvantage_ManimCE_v0.17.3.png" title="nn outputs" class="img-fluid rounded" zoomable=true caption="Left plot shows a cubic function plus noise. Subtracting the cubic function yields the plot on the right, which reduces the variance of the possible values of the function,"%} 


The most common choice for this baseline is the value function, so the above becomes:
