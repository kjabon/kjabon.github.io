...
{% include figure.html path="assets/img/FigFutureReward_ManimCE_v0.17.3.png" title="future reward" class="img-fluid rounded" caption="Rewards (in red) are emitted at each time step. Future return for a time step is the (discounted) sum of all future rewards." %} 
