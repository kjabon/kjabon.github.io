...
{% details I need proof!%}
You're sure you don't want to skip this? Ok, here you go.
...
$$=-\frac{k}{2}\log 2\pi - \log \prod_{i=0}^{k-1}\Sigma_{i,i}^{\frac{1}{2}}$$
...
$$=-\frac{1}{2}\left(k\log 2\pi +  \sum_{i=0}^{k-1}2\log\sigma_{i}\right)$$

Now let's look at the right term of the main equation:
