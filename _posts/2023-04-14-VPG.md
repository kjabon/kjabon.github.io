...
- If the action space is continuous, this is a function which outputs the mean $$\mu$$ and variance $$\sigma^2$$ representing the action's probability distribution. 
