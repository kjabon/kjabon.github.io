...
To begin with, as we will discuss more in the [next section](), we perform batched updates to our neural networks. At a fundamental level, by doing so we are estimating integrals.  
