...
Finally, we sum this term over a set $$\matcha{D}$$ of collected trajectories $$\tau$$, dividing by the number of trajectories $$\vert \mathcal{d} \vert$$ to get the sampled mean of the above equation. 
