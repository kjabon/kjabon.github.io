...
Strangely, I couldn't find anyone else who had done the math for log likelihoods multivariate normal distributions online.
Probably because it's "obvious" to the "mathematically mature," as if there was an objective definition of that.
No, let's be good scientists and double check anything that isn't obvious, especially if it's widely accepted.
