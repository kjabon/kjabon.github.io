...
This article discusses baselines in the context of [vanilla policy gradient](/blog/2023/VPG2/#generalized-advantage-estimation). In that post, we talk more about the intuition of baselines. This could of course be applied to many other algorithms.
