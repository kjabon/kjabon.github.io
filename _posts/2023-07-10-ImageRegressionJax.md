...
{% include figure.html path="assets/img/resnet34wAug.png" title="With data augmentation" class="img-fluid rounded " caption="Training and validation loss upon adding dataAugmentation."%} 
